---
title: "Complete set of code for primary nutrition analyses"
...
set.seed(0)
silh_ID1 = factoextra::fviz_nbclust(data_mean_imp, kmeans, method = "silhouette")
...
clusterplot1 = data.frame(Carb = data_mean_imp$`CARBOHYDRATE, TOTAL (BY DIFFERENCE)`, 
...
wc1 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc2 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc3 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc4 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc5 =wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc6 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc7 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc8 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
# How many PCs to use? -
scree_p1 = plot(summary(pca_scaled )$importance[2, ],  # PVE
     ylab="PVE",
     xlab="Number of PC's",
     pch = 16, 
...
Scaling data is more reasonable since all variables are measured in different units.
...
pve1 = plot(summary(pca)$importance[3, ], pch=16,
     ylab="Cumulative PVE",
     xlab="Number of PC's",
     main="Scree Plot of Cumulative PVE for Nutrients_SCALED")
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc9 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
...
df <- data.frame(word = names(words),freq=words)
set.seed(1234) # for reproducibility 
wc10 = wordcloud(words = df$word, freq = df$freq, min.freq = 1, max.words=100, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
